...
**Hints:**  
1. Use an array `F` of length `38`, where `F[0] = 0`, `F[1] = 1`, and `F[2] = 1`.  
2. Iterate and compute `F[n+3] = F[n] + F[n+1] + F[n+2]`, then return `F[n]`.  

[📂 Solution](Solutions/1137.java)  
